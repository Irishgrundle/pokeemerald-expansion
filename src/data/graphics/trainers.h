...
const u32 gTrainerFrontPic_Bryan[] = INCBIN_U32("graphics/trainers/front_pics/Bryan.4bpp.lz");
const u32 gTrainerPalette_Bryan[] = INCBIN_U32("graphics/trainers/front_pics/Bryan.gbapal.lz");
