...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
    ...
    .nickname = COMPOUND_STRING("Skully"),
    .isShiny = TRUE,
    },
    {
    .lvl = 9,
...
static const struct TrainerMon sParty_GabbyAndTy5[] = {
    ...
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 59,
    .species = SPECIES_RATICATE_ALOLAN_TOTEM,
    }
};
...
static const struct TrainerMon sParty_Brooke1[] = {
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_GIGA_DRAIN, MOVE_SWAGGER, MOVE_WORRY_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
...
static const struct TrainerMon sParty_Cindy2[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TACKLE, MOVE_TAIL_WHIP, MOVE_DIG, MOVE_FAKE_OUT}
    },
    {
    .lvl = 17,
    .species = SPECIES_PRINPLUP,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_WATER_GUN, MOVE_TACKLE, MOVE_BIDE, MOVE_PECK}
    },
    {
    .lvl = 14,
    .species = SPECIES_GLOOM,
...
static const struct TrainerMon sParty_Kirk[] = {
    ...
    .moves = {MOVE_CHARGE, MOVE_SHOCK_WAVE, MOVE_FLAME_CHARGE, MOVE_TAKE_DOWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 26,
...
static const struct TrainerMon sParty_Jace[] = {
    ...
    .moves = {MOVE_SOLAR_BEAM, MOVE_FIRE_BLAST, MOVE_ROCK_TOMB, MOVE_DRAGON_CLAW}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_STEALTH_ROCK, MOVE_BITE, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_METAL_CLAW, MOVE_HARDEN, MOVE_WATER_GUN, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 16,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_HEADBUTT, MOVE_HARDEN, MOVE_ROCK_TOMB, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 17,
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .species = SPECIES_PIGNITE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BRICK_BREAK, MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 22,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BULLET_PUNCH, MOVE_MIND_READER, MOVE_HI_JUMP_KICK, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 21,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FURY_CUTTER, MOVE_AERIAL_ACE, MOVE_LEAF_BLADE, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 24,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_THROW, MOVE_LOW_KICK, MOVE_MIMIC, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .moves = {MOVE_STICKY_WEB, MOVE_ELECTRO_BALL, MOVE_ENERGY_BALL, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 29,
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_THUNDER_WAVE, MOVE_CHARM}
    },
    {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WILD_CHARGE, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_CROSS_CHOP}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 29,
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_HYPER_BEAM, MOVE_MAGNET_RISE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 30,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_ELECTRO_BALL, MOVE_ELECTRIC_TERRAIN, MOVE_SURF}
    },
    {
    ...
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_HIDDEN_POWER}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_SOLAR_BEAM, MOVE_FIRE_BLAST, MOVE_OVERHEAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 43,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_SUNNY_DAY, MOVE_FLAME_CHARGE, MOVE_AMNESIA}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 43,
    ...
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_FLARE_BLITZ, MOVE_DRAIN_PUNCH, MOVE_SWORDS_DANCE, MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 47,
    ...
    .moves = {MOVE_DETECT, MOVE_FLARE_BLITZ, MOVE_THUNDER_PUNCH, MOVE_BRAVE_BIRD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 44,
    ...
    .moves = {MOVE_SLUDGE_BOMB, MOVE_OVERHEAT, MOVE_HYPER_VOICE, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_ROAR, MOVE_U_TURN, MOVE_COTTON_GUARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 47,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STEALTH_ROCK, MOVE_SUBSTITUTE, MOVE_TOXIC, MOVE_MILK_DRINK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_POWER_UP_PUNCH, MOVE_AERIAL_ACE, MOVE_SEISMIC_TOSS}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLWIND, MOVE_FLY, MOVE_FACADE, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    ...
    .moves = {MOVE_BELLY_DRUM, MOVE_ZEN_HEADBUTT, MOVE_REST, MOVE_BODY_SLAM}
    },
...
static const struct TrainerMon sParty_AnnaAndMeg1[] = {
    ...
    .moves = {MOVE_BATON_PASS, MOVE_PROTECT, MOVE_BUG_BITE, MOVE_SLASH}
    },
    {
    .lvl = 23,
    .species = SPECIES_NUZLEAF,
    .moves = {MOVE_BIDE, MOVE_HARDEN, MOVE_AERIAL_ACE, MOVE_GIGA_DRAIN}
    }
};
...
static const struct TrainerMon sParty_Victor[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SPIKES, MOVE_WHIRLWIND, MOVE_ROOST, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(23, 23, 23, 23, 23, 23),
    .lvl = 32,
...
static const struct TrainerMon sParty_Victoria[] = {
    ...
    .moves = {MOVE_SPARK, MOVE_VOLT_SWITCH, MOVE_TOXIC_SPIKES, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(23, 23, 23, 23, 23, 23),
    .lvl = 32,
    .species = SPECIES_RAICHU_ALOLAN,
    .heldItem = ITEM_AIR_BALLOON,
    .moves = {MOVE_THUNDER, MOVE_PSYCHIC, MOVE_ELECTRIC_TERRAIN, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(23, 23, 23, 23, 23, 23),
    .lvl = 32,
    .species = SPECIES_JOLTEON,
    .heldItem = ITEM_AIR_BALLOON,
    .moves = {MOVE_VOLT_SWITCH, MOVE_SHADOW_BALL, MOVE_PIN_MISSILE, MOVE_QUICK_ATTACK}
    },
};
...
static const struct TrainerMon sParty_Vicky[] = {
    ...
    .moves = {MOVE_ICE_PUNCH, MOVE_BULK_UP, MOVE_ZEN_HEADBUTT, MOVE_RECOVER}
    },
};
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .lvl = 15,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_TACKLE, MOVE_ROCK_TOMB, MOVE_DEFENSE_CURL, MOVE_NONE}
    },  
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 15,
    ...
    .moves = {MOVE_COPYCAT, MOVE_ROCK_TOMB, MOVE_HARDEN, MOVE_MIMIC}
    }
};
...
static const struct TrainerMon sParty_Ben[] = {
    ...
    .lvl = 27,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_HEADBUTT, MOVE_PIN_MISSILE, MOVE_GROWL, MOVE_THUNDERBOLT}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 27,
...
static const struct TrainerMon sParty_Lao1[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_HEADBUTT, MOVE_SLUDGE_BOMB, MOVE_EXPLOSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 40,
...
static const struct TrainerMon sParty_Madeline1[] = {
    ...
    .moves = {MOVE_OVERHEAT, MOVE_TAKE_DOWN, MOVE_EARTHQUAKE, MOVE_SUNNY_DAY}
    }
};
...
static const struct TrainerMon sParty_Eli[] = {
    ...
    .moves = {MOVE_FIRE_FANG, MOVE_DRAGON_TAIL, MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMon sParty_Danielle[] = {
    ...
    .lvl = 42,
    .species = SPECIES_MEDICHAM,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_DETECT, MOVE_ZEN_HEADBUTT, MOVE_FIRE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 40,
...
static const struct TrainerMon sParty_TyraAndIvy[] = {
    ...
    .lvl = 40,
    .species = SPECIES_GOLEM,
    .moves = {MOVE_FIRE_PUNCH, MOVE_MAGNITUDE, MOVE_SMACK_DOWN, MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMon sParty_Angelo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KIRLIA,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_CALM_MIND, MOVE_NONE}
    }
};
